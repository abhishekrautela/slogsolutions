...
?>
<div id="banner-area">
    <img class="img-fluid" width="100%" height="100%" src="admin/<?php echo $result['image'] ?>" alt="" />
        ...
        <form method="POST">
            <div class="row">
                ...
                <a href="down.php?duration=<?php echo $result['duration']?>&technology=<?php echo $result['technology']?>"
                    class="btn btn-primary solid">Download <?php echo $result['duration'] ?> Course Content <i
