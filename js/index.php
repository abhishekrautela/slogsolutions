				...
				<nav class="collapse navbar-collapse clearfix" role="navigation">
					<ul class="nav navbar-nav navbar-right">
	                    ...
	                    <li class="dropdown">
							   ...
							   <div class="dropdown-menu">
								<ul>
		                           	 <li><a href="speaker.php">Be a Speaker</a></li>
	                    ...
	                    <li class="dropdown">
                       		<a href="training.php" >Training <i class="fa fa-angle-down"></i></a>
                         </li>
			...
			<ul class="cd-hero-slider">
				<li class="selected">
					...
					<div class="cd-full-width">
						<h2>Need a motivational speaker? WE GOT YOU!!!</h2>
						<h3>We Making Difference To Great Things Possible</h3>
						<a href="speaker.php" class="btn btn-primary white cd-btn">Start Now</a>
				...
				<li>
					...
					<div class="cd-full-width">
						...
						<h3>Get certified with our training programs</h3>
						<a href="training.php" class="btn btn-primary white cd-btn">Start Now</a>
		...
		<div class="cd-slider-nav">
			<nav>
				...
				<ul>
					...
					<li><a href="#0"><i class="fa fa-hotel"></i> Speaker</a></li>
					<li><a href="#0"><i class="fa fa-android"></i> Training</a></li>
				</ul>
			</nav> 
		</div> <!-- .cd-slider-nav -->
				...
				<div class="col-md-12">
					<div class="col-md-3 col-sm-3 wow fadeInDown" data-wow-delay=".5s">
						<div class="service-content text-center">
							...
							<h3>Web Designing</h3>
							<p>Get Your websites designed</p>
						</div>
			...
			<div class="row text-right">
				<div class="isotope-nav" data-isotope-nav="isotope">
					<ul>
						...
						<li><a href="#" data-filter=".development">Motivation</a></li>
						<li><a href="#" data-filter=".joomla">Training</a></li>
						<li><a href="#" data-filter=".wordpress">FDP</a></li>
					</ul>
				</div>
